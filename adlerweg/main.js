    ...
    for (let einkehr of EINKEHR) {
        ...
        let mrk = L.marker([einkehr[2], einkehr[3]], {
                icon: L.icon({
                    ...
                    iconAnchor: [16, 37],
                    popupAnchor: [0, -37],
                    iconUrl: "icons/restaurant.png" // es muss das icon noch runter geladen werden!!!
                })
...
let controlElevation = L.conrtol.eleveation({
    theme: "adler-theme",
    detached: true,
...
// http://secure.geonames.org/wikipediaBoundingBoxJSON?north=44.1&south=-9.9&east=-22.4&west=55.2&username=HeiligerBimBam